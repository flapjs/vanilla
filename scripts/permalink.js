 ...
 * @returns {[string, string]} [type of the graph in {"NFA", "PDA", "Turing"}, rest of the unparsed graph string]
 */
 ...
 * @param {string} graph_str - the string representation of the graph
 * @returns {[string, Object]} [type of the graph in {"NFA", "PDA", "Turing"}, graph]
 */
